...
def eliminar_cliente(base_datos: dict):
    ...
    #Ejemplo con del base_datos[nif]
    ...
    """
    Ejemplo con base_datos.pop(nif, None)

    eliminado = base_datos.pop(nif, None)
